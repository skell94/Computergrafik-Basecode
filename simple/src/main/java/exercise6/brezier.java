...
public class brezier {
	...
	public final static class SimpleRenderPanel extends GLRenderPanel {
		...
		public void init(RenderContext r) {
			...
			Vector2f[] controlPoints = new Vector2f[19];
			
			controlPoints[0] = new Vector2f(0,0);
			controlPoints[1] = new Vector2f(0,.4f);
			controlPoints[2] = new Vector2f(.15f,1);
			controlPoints[3] = new Vector2f(1,1);
			
			controlPoints[4] = new Vector2f(1.15f,1);
			controlPoints[5] = new Vector2f(2,.6f);
			controlPoints[6] = new Vector2f(2,.2f);
			
			controlPoints[7] = new Vector2f(2.25f,.2f);
			controlPoints[8] = new Vector2f(2.5f,.6f);
			controlPoints[9] = new Vector2f(2.5f,1.1f);
			
			controlPoints[10] = new Vector2f(2.6f,1.1f);
			controlPoints[11] = new Vector2f(2.6f,1.1f);
			controlPoints[12] = new Vector2f(2.7f,1.1f);
			
			controlPoints[13] = new Vector2f(2.7f,.6f);
			controlPoints[14] = new Vector2f(2.95f,.2f);
			controlPoints[15] = new Vector2f(3.2f,.2f);
			
			controlPoints[16] = new Vector2f(3.8f,1.4f);
			controlPoints[17] = new Vector2f(4.2f,1.8f);
			controlPoints[18] = new Vector2f(5.2f,2.2f);
			
			VertexData vertexData = ShapeHelpers.surfaceOfRevolution(renderContext, 6, controlPoints, 100, 20);
			...
			Matrix4f scale = new Matrix4f(), t = shape.getTransformation();
			scale.set(.25f);
			t.mul(scale);
			scale.set(new Vector3f(-3,0,0));
			t.mul(scale);
